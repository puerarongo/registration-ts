...
const Sidebar: React.FC<ISidebar> = ({ step, setStep, active }) => {
  ...
  const { shopify, google, welcomeActive, shopifyActive, googleActive } =
  ...
  return (
    <section className={styles.section}>
      <Media
        queries={{ small: '(max-width: 1349px)', large: '(min-width: 1350px)' }}
      >
        {matches => (
          <>
            {' '}
              ...
              <div className={styles.container}>
                ...
                {active && (
                  <div className={styles.switch__container}>
                    ...
                    <button
                      className={styles.switch__right}
                      type="button"
                      onClick={() => nextStep()}
                  ...
                  {active && (
                    <div className={styles.switch__container}>
                      ...
                      >
                        <svg className={styles.svg__left}>
                          <use
                            href={svgPath.larrow_left + '#larrow_left'}
                          ></use>
                        </svg>
                        Back
                      </button>
                      ...
                      >
                        ...
                        <svg className={styles.svg__right}>
                          <use
                            href={svgPath.larrow_right + '#larrow_right'}
                          ></use>
                        </svg>
                      </button>
                    </div>
