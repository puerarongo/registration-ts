  ...
  return (
    <>
      ...
      <p className={styles.text}>
        Chad Beta is currently only available on Shopify. Well send you an email
        when Chad becomes available on your platform.
      </p>
      <SelectComponent
        data={dataArr}
        value={selectValue}
        setValue={setSelectVlaue}
      />
      ...
      <p className={styles.text__link}>
        ...
        <button className={styles.link} type="button" onClick={returnHandle}>
          {' '}
          Connect
        </button>
      </p>
